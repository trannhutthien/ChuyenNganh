    ...
    <div class="max-w-7xl mx-auto px-6 py-6">
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
        ...
        <div class="flex-1">
          ...
          <p class="text-gray-600 mb-4">{{ quizDescription }}</p>
          ...
          <div class="flex flex-wrap gap-4">
            ...
            <!-- Attempts Left -->
            <div v-if="quizAttemptsLeft !== null" class="flex items-center gap-2 text-gray-700">
              ...
              <span class="font-medium text-amber-600">Còn {{ quizAttemptsLeft }} lần làm</span>
            </div>
...
const quizTitle = computed(() => props.quiz?.title || props.quiz?.tieuDe || 'Bài kiểm tra')
const quizDescription = computed(() => props.quiz?.description || props.quiz?.moTa || '')
const quizDuration = computed(() => props.quiz?.duration_minutes || props.quiz?.thoiGianLamBai || 30)
const quizTotalQuestions = computed(() => props.quiz?.total_questions || props.quiz?.soCauHoiThucTe || props.quiz?.soCauHoi || 0)
...
const quizAttemptsLeft = computed(() => {
  ...
  if (props.quiz?.soLanLamToiDa !== undefined && props.quiz?.soLanDaLam !== undefined) {
