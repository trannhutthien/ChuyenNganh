<template>
  <div class="flex gap-4 items-center p-4 transition-colors hover:bg-gray-50">
    <!-- Order Number -->
    <div
      class="flex justify-center items-center w-10 h-10 text-sm font-bold rounded-full bg-primary/10 text-primary"
    >
      {{ order }}
    </div>
    ...
    <div class="flex-1 min-w-0">
      ...
      <div class="flex gap-3 items-center mt-1 text-sm text-gray-500">
...
const props = defineProps({
  ...
  type: {
    ...
    default: "video",
    validator: (value) =>
      ["video", "text", "quiz", "assignment"].includes(value),
  },
  order: {
    type: Number,
    default: 1,
