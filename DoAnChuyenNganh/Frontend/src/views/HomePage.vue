...
const fetchProCourses = async () => {
  ...
  try {
    const response = await courseService.getProCourses(20)
...
const fetchFreeCourses = async () => {
  ...
  try {
    const response = await courseService.getFreeCourses(20)
    // response đã được unwrap bởi interceptor, nên data nằm trực tiếp trong response
